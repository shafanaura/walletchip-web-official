...
function Home() {
  ...
  const showNotif = (amount) => {
    toast.dark(
      `You Received a Transfer Rp. ${amount}, Please Check your history`,
      {
                  ...
                  <div className="row my-3">
                    <div className="d-grid">
                      <button className="btn border border-2 py-2 btn-balance-control fw-bold">
                        <i
                          className="far fa-arrow-up me-3"
                          style={{ color: "#E0E0E0" }}
                        ></i>
                        <Link
                          to="/transfer"
                                  ...
                                  <div className="col-9">
                                    <div className="row">
                                      <span className="fw-bold">
                                        {transaction.another_user}
                                      </span>
                                      <small className="text-muted">
                                        {transaction.did_user_transfer === 1
                                          ? "Subscription"
                                          : "Transfer"}
                                      </small>
                                    </div>
