      ...
      <div className="card px-4 pt-3 shadow-sm border-rad">
        ...
        <div className="card-body overflow-auto card-transfer-success">
          ...
          <div className="row mt-3">
            <span className="fw-bold">Transfer To</span>
          </div>
          <div className="row">
                    ...
                    <small className="text-muted">
                      {`${
                        transaction.user.phone === null
                          ? "Phone Number has been not updated"
          ...
          <div className="d-flex justify-content-end mt-4 mb-5">
            <button className="btn fw-bold text-dark border-0 text-end py-3 px-4 mx-2 btn-gray">
              <i className="far fa-share-alt"></i>
            </button>
            <button className="btn fw-bold  border-0 text-end py-3 mx-2 btn-gray text-blue">
              <i className="far fa-download me-3"></i> Download PDF
            </button>
            <button className="btn btn-blue fw-bold text-white border-0 text-end py-3 mx-2">
