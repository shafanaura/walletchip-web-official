  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      picture: Yup.mixed()
        ...
        .test(
          "imageSize",
          "The maximum image size is only 3MB",
  ...
  return (
    <div className="card shadow-sm">
      <div
        ...
        className="card-body overflow-auto p-5"
      >
        <div className="container text-center">
          <div className="profile-img">
            ...
            <form id="form-image" className="mt-2 d-flex flex-column">
              ...
              <label
                style={{ cursor: "pointer", color: "#7A7886" }}
                htmlFor="picture"
              >
                <svg
                  width="13"
          ...
          <h5 style={{ color: "#4D4B57" }} className="fw-bold fs-5 mt-3">
            {user.first_name
          ...
          <div style={{ paddingLeft: "7rem", paddingRight: "7rem" }}>
            <Link
              ...
              className="btn btn-profile-navigation p-3 w-100 my-2"
            >
            ...
            <Link
              to={`/profile/${user.username}/change-password`}
              className="btn btn-profile-navigation p-3 w-100 my-2"
            >
              <div className="d-flex align-items-center justify-content-between">
            ...
            <Link
              to={`/profile/${user.username}/change-pin`}
              className="btn btn-profile-navigation p-3 w-100 my-2"
            >
              <div className="d-flex align-items-center justify-content-between">
